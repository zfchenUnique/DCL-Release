...
jac-crun ${GPU_ID} scripts/trainval_tube_v2.py --desc clevrer/desc_nscl_derender_clevrer_v2.py\
    ...
    --regu_only_flag 0 \
    --pretrain_pred_spatial_model ../remote_models/prpAttrV3_spatial_net_best.pth \
    --ftr_in_collision_space_flag 0 \
    ...
    --prefix rgb_sep_refineMatch_all \
    --evaluate \
    --load ${MODEL_PATH} \
    --testing_flag 1 \
    --tube_prp_path ../clevrer/tubeProposalsAttrMatchTest/1.0_1.0_0.6_0.7 \
    --unseen_events_path ../temporal_reasoningv2/dumps/annos/tubeNetAttrV3_offset4_test_separate_realOffset5_noAttr_noEdgeSuperv \
    --test_result_path ${TEST_PATH} \
    #--debug \
    #--load dumps/clevrer/desc_nscl_derender_clevrer_v2/v2_norm_box_even_smp31_col_box_ftr_v2_rgb_sep_refineMatch_all/checkpoints/epoch_2.pth \
