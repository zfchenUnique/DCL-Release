...
jac-crun ${GPU_ID} scripts/trainval_tube_v2.py --desc clevrer/desc_nscl_derender_clevrer_v2.py \
    ...
    --evaluate \
    --load ${MODEL_PATH} \
    #--load dumps/clevrer/desc_nscl_derender_clevrer_v2/v2_norm_box_even_smp31_col_box_ftr_v2_refineMatch_des_exp/checkpoints/epoch_14.pth  \
