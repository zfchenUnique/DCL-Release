...
jac-crun ${GPU_ID} scripts/trainval_tube_v2.py --desc clevrer/desc_nscl_derender_clevrer_v2.py\
    ...
    --correct_question_path ../clevrer/expressions/exp_val_grounding_v1/parse_pg.json \
    #--data-workers  2 \
    #--debug \
    ...
    #--tube_prp_path ../clevrer/tubeProposalsGt \
    #--expression_path /home/zfchen/code/nsclClevrer/clevrer/expressions/exp_val_v1 \
    #--visualize_flag 1 \
    #--visualize_gif_flag 1 \
    #--visualize_ground_vid 10012 \
    #--tube_prp_path ../clevrer/tubeProposalsGt \
    #--retrieval_mode 0 \
    #--expression_path /home/zfchen/code/nsclClevrer/clevrer/expressions/exp_val_retrieval_v1/1000_100_3/retrieval_exp.json \
    #--visualize_flag 1 \
    #--testing_flag 1 \
