...
jac-crun ${GPU_ID} scripts/trainval_tube_v2.py --desc clevrer/desc_nscl_derender_clevrer_v2.py\
    ...
    --unseen_events_path /home/zfchen/code/nsclClevrer/temporal_reasoning-master/dumps/propnet_predictions_prpAttrV3_noAttr_noEdgeSuperv \
    #--debug \
