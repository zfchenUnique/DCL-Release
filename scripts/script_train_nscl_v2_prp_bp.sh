...
jac-crun ${GPU_ID} scripts/trainval_tube_v2.py --desc clevrer/desc_nscl_derender_clevrer_v2.py\
    ...
    --pretrain_pred_model_path ../temporal_reasoning-master/dumps/latent_prp_CLEVRER_noAttr_noEdgeSuperv_pn_pstep_2_version_v3/tube_net_epoch_2_iter_400000.pth \
    --debug
    #--tube_prp_path ../clevrer/tubeProposalsAttrV0/1.0_1.0_0.5 \
    #--pretrain_pred_model_path ../temporal_reasoning-master/dumps/prpRefine_latent_norm_ftr_0001_CLEVRER_noAttr_noEdgeSuperv_pn_pstep_2_version_v3/tube_net_epoch_0_iter_400000.pth \
